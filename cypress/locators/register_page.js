export const register_page = {
    // signup_supplier_btn: '#root > div > div > div > form > div.RegisterForm_buttons_container_user_role__odHqW > button.Button_button__-\+nph.Button_white__PFVOl.RegisterForm_button_user_role__ax6bX',
    signup_supplier_btn: '//*[@id="root"]/div/div/div/form/div[1]/button[2]',
    email_field: '#root > div > div > div > form > div:nth-child(2) > input',
